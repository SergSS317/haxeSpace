...
Base.prototype = {
	...
	,update: function() {
		this.timer.update();
		Base.camera.maxzoom = Sleeve.MaxCoord * 2;
		Base.camera.update(this.controls,this.timer.deltaTime);
	...
	,render: function(frame) {
		...
		if(this.uiController != null) {
			this.uiController.render(frame.get_g2());
		}
		g.end();
	}
	,reset: function() {
...
var Button = function(x,y,width,height,color) {
	...
	this.height = height;
	this.color = color;
	MouseControl.onMouseButtonDown.push($bind(this,this.onMouseDown));
};
...
var Camera = function(_x,_y) {
	this.speed = 1.0;
	this.x = _x;
	this.y = _y;
	this.maxzoom = 500000.0;
	this.minzoom = 5;
	this.zoom = 10000;
	Camera.startZoom = 1000;
...
Camera.prototype = {
	...
	,TransformUpdate: function() {
		...
		m__23 = 0;
		m__33 = 1;
		Camera.Matrix = new kha_math_FastMatrix4(_this2._00 * m__00 + _this2._10 * m__01 + _this2._20 * m__02 + _this2._30 * m__03,_this2._00 * m__10 + _this2._10 * m__11 + _this2._20 * m__12 + _this2._30 * m__13,_this2._00 * m__20 + _this2._10 * m__21 + _this2._20 * m__22 + _this2._30 * m__23,_this2._00 * m__30 + _this2._10 * m__31 + _this2._20 * m__32 + _this2._30 * m__33,_this2._01 * m__00 + _this2._11 * m__01 + _this2._21 * m__02 + _this2._31 * m__03,_this2._01 * m__10 + _this2._11 * m__11 + _this2._21 * m__12 + _this2._31 * m__13,_this2._01 * m__20 + _this2._11 * m__21 + _this2._21 * m__22 + _this2._31 * m__23,_this2._01 * m__30 + _this2._11 * m__31 + _this2._21 * m__32 + _this2._31 * m__33,_this2._02 * m__00 + _this2._12 * m__01 + _this2._22 * m__02 + _this2._32 * m__03,_this2._02 * m__10 + _this2._12 * m__11 + _this2._22 * m__12 + _this2._32 * m__13,_this2._02 * m__20 + _this2._12 * m__21 + _this2._22 * m__22 + _this2._32 * m__23,_this2._02 * m__30 + _this2._12 * m__31 + _this2._22 * m__32 + _this2._32 * m__33,_this2._03 * m__00 + _this2._13 * m__01 + _this2._23 * m__02 + _this2._33 * m__03,_this2._03 * m__10 + _this2._13 * m__11 + _this2._23 * m__12 + _this2._33 * m__13,_this2._03 * m__20 + _this2._13 * m__21 + _this2._23 * m__22 + _this2._33 * m__23,_this2._03 * m__30 + _this2._13 * m__31 + _this2._23 * m__32 + _this2._33 * m__33);
	}
	,update: function(controls,deltaTime) {
		if(controls.left && !controls.right) {
			this.x -= this.speed * deltaTime * this.zoom;
		} else if(controls.right && !controls.left) {
			this.x += this.speed * deltaTime * this.zoom;
		}
		if(controls.up && !controls.down) {
			this.y += this.speed * deltaTime * this.zoom;
		} else if(controls.down && !controls.up) {
			this.y -= this.speed * deltaTime * this.zoom;
		}
		if(MouseControl.btnLeft) {
			this.Xm = MouseControl.x;
			this.Ym = MouseControl.y;
			if(this.oldXm == 0 && this.oldYm == 0) {
				this.oldXm = this.Xm;
				this.oldYm = this.Ym;
			}
			this.x += this.speed / 30 * deltaTime * this.zoom * (this.oldXm - this.Xm);
			this.y -= this.speed / 30 * deltaTime * this.zoom * (this.oldYm - this.Ym);
			this.oldXm = this.Xm;
			this.oldYm = this.Ym;
		}
		if(!MouseControl.btnLeft) {
		...
		Camera.startZoom += deltaTime * (MouseControl.z - this.oldZm) * Camera.startZoom;
		if(controls.zoomup && !controls.zoomdown) {
			Camera.startZoom -= deltaTime * Camera.startZoom;
		} else if(controls.zoomdown && !controls.zoomup) {
			Camera.startZoom += deltaTime * Camera.startZoom;
		}
		this.oldZm = MouseControl.z;
		if(Camera.startZoom < 1) {
			Camera.startZoom = 1;
		}
		this.zoom = Math.pow(Camera.startZoom,2);
		if(this.zoom < this.minzoom) {
			this.zoom = this.minzoom;
			Camera.startZoom = Math.sqrt(this.minzoom);
		}
		if(this.zoom > this.maxzoom) {
			this.zoom = this.maxzoom;
			Camera.startZoom = Math.sqrt(this.maxzoom);
		}
		Camera.ZoomKoef = this.zoom / this.maxzoom;
		this.TransformUpdate();
	}
	,__class__: Camera
};
...
var Drawning = function(_imageData,Lenght) {
	...
	this.id = ++Drawning.idtmp;
	this.CreateNewVertexBufer(Lenght);
};
$hxClasses["Drawning"] = Drawning;
Drawning.__name__ = ["Drawning"];
Drawning.prototype = {
	vertexBuffer: null
	,indexBuffer: null
	,imageData: null
	...
	,UpdateVertex: null
	,UpdateAllBuff: null
	,CreateNewVertexBufer: function(Lenght) {
		this.vertexBuffer = new kha_graphics4_VertexBuffer(Lenght | 0,Set3d.structure,kha_graphics4_Usage.DynamicUsage);
		this.CreateIndexBuffer(Lenght);
		this.UpdateAllBuff = true;
	}
	,update: function() {
	}
	,UpdateBuffers: function() {
		...
		var tmp2 = 0;
		var vbData;
		if(this.UpdateVertex || this.UpdateAllBuff) {
			vbData = this.vertexBuffer.lock();
			var _g1 = 0;
			var _g = vbData.length / Set3d.structureLength + 1 | 0;
			while(_g1 < _g) {
				var i = _g1++;
				tmp1 = i * Set3d.structureLength;
				tmp2 = i * 3;
				if(this.vertices[tmp2] != null) {
					vbData[tmp1] = this.vertices[tmp2];
					vbData[tmp1 + 1] = this.vertices[tmp2 + 1];
					vbData[tmp1 + 2] = this.vertices[tmp2 + 2];
				} else {
					vbData[tmp1] = 0;
					vbData[tmp1 + 1] = 0;
					vbData[tmp1 + 2] = 0;
		...
		if(this.UpdateUV || this.UpdateAllBuff) {
			var vbData1 = this.vertexBuffer.lock();
			var _g11 = 0;
			var _g2 = vbData1.length / Set3d.structureLength | 0;
			while(_g11 < _g2) {
				var i1 = _g11++;
				if(this.uvs[i1 * 2] != null) {
					vbData1[i1 * Set3d.structureLength + 3] = this.uvs[i1 * 2];
					vbData1[i1 * Set3d.structureLength + 4] = this.uvs[i1 * 2 + 1];
				} else {
					vbData1[i1 * Set3d.structureLength + 3] = 0;
					vbData1[i1 * Set3d.structureLength + 4] = 0;
				}
			}
			this.vertexBuffer.unlock();
		}
		if(this.UpdateColor || this.UpdateAllBuff) {
			var vbData2 = this.vertexBuffer.lock();
			var _g12 = 0;
			var _g3 = vbData2.length / Set3d.structureLength | 0;
			while(_g12 < _g3) {
				var i2 = _g12++;
				if(this.colors[i2 * 4] != null) {
					vbData2[i2 * Set3d.structureLength + 5] = this.colors[i2 * 4];
					vbData2[i2 * Set3d.structureLength + 6] = this.colors[i2 * 4 + 1];
					vbData2[i2 * Set3d.structureLength + 7] = this.colors[i2 * 4 + 2];
					vbData2[i2 * Set3d.structureLength + 8] = this.colors[i2 * 4 + 3];
				} else {
					vbData2[i2 * Set3d.structureLength + 5] = 0;
					vbData2[i2 * Set3d.structureLength + 6] = 0;
					vbData2[i2 * Set3d.structureLength + 7] = 0;
					vbData2[i2 * Set3d.structureLength + 8] = 0;
				}
			}
			this.vertexBuffer.unlock();
		}
	...
	,CreateIndexBuffer: function(count) {
		var indices = [];
		var _g1 = 0;
		var _g = count | 0;
		while(_g1 < _g) {
	...
	,render: function(g) {
		...
		g.setTexture(Set3d.pipeline.getTextureUnit("Light9"),this.imageData);
...
var Entity = function(_position,_color,_size,_drawbufs,_uvs,_static) {
	if(_static == null) {
		_static = true;
	}
	this.tmp = 0;
...
Entity.prototype = {
	...
	,AddUV: function(_uvs) {
		if(_uvs != null) {
			...
			this.uvs = [0,0,0,1,1,1,0,0,1,0,1,1];
		}
	}
	,UpdateUVS: function() {
		this.tmp = this.id * 12;
		this.drawbufs.uvs[this.tmp] = this.uvs[0];
		this.drawbufs.uvs[this.tmp + 1] = this.uvs[1];
		this.drawbufs.uvs[this.tmp + 2] = this.uvs[2];
		this.drawbufs.uvs[this.tmp + 3] = this.uvs[3];
		this.drawbufs.uvs[this.tmp + 4] = this.uvs[4];
		this.drawbufs.uvs[this.tmp + 5] = this.uvs[5];
		this.drawbufs.uvs[this.tmp + 6] = this.uvs[6];
		this.drawbufs.uvs[this.tmp + 7] = this.uvs[7];
		this.drawbufs.uvs[this.tmp + 8] = this.uvs[8];
		this.drawbufs.uvs[this.tmp + 9] = this.uvs[9];
		this.drawbufs.uvs[this.tmp + 10] = this.uvs[10];
		this.drawbufs.uvs[this.tmp + 11] = this.uvs[11];
	}
	,UpdateVert: function() {
		this.tmp = this.id * 18;
		this.drawbufs.vertices[this.tmp] = -this.Size + this.Position.x;
		this.drawbufs.vertices[this.tmp + 1] = -this.Size + this.Position.y;
		this.drawbufs.vertices[this.tmp + 2] = 0;
		this.drawbufs.vertices[this.tmp + 3] = -this.Size + this.Position.x;
		this.drawbufs.vertices[this.tmp + 4] = this.Size + this.Position.y;
		this.drawbufs.vertices[this.tmp + 5] = 0;
		this.drawbufs.vertices[this.tmp + 6] = this.Size + this.Position.x;
		this.drawbufs.vertices[this.tmp + 7] = this.Size + this.Position.y;
		this.drawbufs.vertices[this.tmp + 8] = 0;
		this.drawbufs.vertices[this.tmp + 9] = -this.Size + this.Position.x;
		this.drawbufs.vertices[this.tmp + 10] = -this.Size + this.Position.y;
		this.drawbufs.vertices[this.tmp + 11] = 0;
		this.drawbufs.vertices[this.tmp + 12] = this.Size + this.Position.x;
		this.drawbufs.vertices[this.tmp + 13] = -this.Size + this.Position.y;
		this.drawbufs.vertices[this.tmp + 14] = 0;
		this.drawbufs.vertices[this.tmp + 15] = this.Size + this.Position.x;
		this.drawbufs.vertices[this.tmp + 16] = this.Size + this.Position.y;
		this.drawbufs.vertices[this.tmp + 17] = 0;
	}
	,UpdateColor: function() {
		...
		while(_g < 6) {
			var i = _g++;
			this.drawbufs.colors[this.tmp + i * 4] = ((this.color & 16711680) >>> 16) * 0.00392156862745098;
			this.drawbufs.colors[this.tmp + i * 4 + 1] = ((this.color & 65280) >>> 8) * 0.00392156862745098;
			this.drawbufs.colors[this.tmp + i * 4 + 2] = (this.color & 255) * 0.00392156862745098;
			this.drawbufs.colors[this.tmp + i * 4 + 3] = (this.color >>> 24) * 0.00392156862745098;
		}
	}
	,AddColor: function() {
		var _g = 0;
		while(_g < 6) {
			var i = _g++;
			this.drawbufs.colors.push(((this.color & 16711680) >>> 16) * 0.00392156862745098);
			this.drawbufs.colors.push(((this.color & 65280) >>> 8) * 0.00392156862745098);
			this.drawbufs.colors.push((this.color & 255) * 0.00392156862745098);
			this.drawbufs.colors.push((this.color >>> 24) * 0.00392156862745098);
		}
	}
	,AddVert: function() {
		this.tmp = this.id * 18;
		this.drawbufs.vertices.push(-this.Size + this.Position.x);
		this.drawbufs.vertices.push(-this.Size + this.Position.y);
		this.drawbufs.vertices.push(0);
		this.drawbufs.vertices.push(-this.Size + this.Position.x);
		this.drawbufs.vertices.push(this.Size + this.Position.y);
		this.drawbufs.vertices.push(0);
		this.drawbufs.vertices.push(this.Size + this.Position.x);
	...
	,AddUVS: function(_uvs) {
		var _g = 0;
		while(_g < 12) {
			var i = _g++;
			this.drawbufs.uvs.push(_uvs[i]);
		}
	}
	,__class__: Entity
};
...
$hxClasses["FpsControl"] = FpsControl;
FpsControl.__name__ = ["FpsControl"];
FpsControl.prototype = {
	...
	,timer: null
	,update: function() {
		this.realTime = kha_Scheduler.realTime();
		this.timer += this.realTime - this.previousRealTime;
		if(this.timer > 0.5) {
			this.timer -= 0.5;
			this.FPS = this.fps_counter * 2;
			this.fps_counter = 0;
			this.fps_temp = 0;
		}
		this.fps_temp = Math.round(1.0 / (this.realTime - this.previousRealTime));
		this.fps_counter++;
		this.previousRealTime = this.realTime;
	}
	,__class__: FpsControl
};
var Galaxy = function(starCount,galaxySleeve,speenPower,_seed) {
	this.Sleeves = [];
...
$hxClasses["Galaxy"] = Galaxy;
Galaxy.__name__ = ["Galaxy"];
Galaxy.prototype = {
	Sleeves: null
	,StarCount: null
	,GalaxySleeve: null
	...
	,GenerateGalaxy: function() {
		var _g1 = 1;
		var _g = this.GalaxySleeve + 1;
		while(_g1 < _g) {
			var i = _g1++;
			this.Sleeves.push(new Sleeve(Math.round(this.StarCount / this.GalaxySleeve),this.SpeenPower,2 * Math.PI / this.GalaxySleeve * i));
		}
		this.AddStars(this.StarCount);
	}
	,AddStars: function(Count) {
		haxe_Log.trace("Add Stars: " + Count,{ fileName : "Galaxy.hx", lineNumber : 43, className : "Galaxy", methodName : "AddStars"});
		var _g = 0;
		var _g1 = this.Sleeves;
		while(_g < _g1.length) {
			var sleeve = _g1[_g];
			++_g;
			sleeve.AddStars(Math.round(Count / this.Sleeves.length));
		}
	}
	,update: function() {
		var _g = 0;
...
Main.__name__ = ["Main"];
Main.main = function() {
	haxe_Log.trace("start",{ fileName : "Main.hx", lineNumber : 11, className : "Main", methodName : "main"});
	Main.screen = new kha_math_FastVector2(800,600);
	kha_System.init({ title : "Base", width : Main.screen.x | 0, height : Main.screen.y | 0},Main.init);
};
Main.init = function() {
	var game = new Base();
...
var MouseControl = function() {
	MouseControl.onMouseButtonDown = [];
	MouseControl.onMouseButtonUp = [];
	kha_input_Mouse.get().notify($bind(this,this.onMouseDown),$bind(this,this.onMouseUp),$bind(this,this.onMouseMove),$bind(this,this._onMouseWheel));
};
$hxClasses["MouseControl"] = MouseControl;
MouseControl.__name__ = ["MouseControl"];
MouseControl.prototype = {
	onMouseDown: function(button,x,y) {
		if(button == 0) {
			MouseControl.btnLeft = true;
			if(MouseControl.onMouseButtonDown != null) {
				var _g1 = 0;
				var _g = MouseControl.onMouseButtonDown.length;
				while(_g1 < _g) {
					var i = _g1++;
					MouseControl.onMouseButtonDown[i](0);
				}
			}
		}
		if(button == 1) {
			MouseControl.btnRight = true;
			if(MouseControl.onMouseButtonDown != null) {
				var _g11 = 0;
				var _g2 = MouseControl.onMouseButtonDown.length;
				while(_g11 < _g2) {
					var i1 = _g11++;
					MouseControl.onMouseButtonDown[i1](1);
				}
			}
		}
		if(button == 2) {
			MouseControl.btnMiddle = true;
			if(MouseControl.onMouseButtonDown != null) {
				var _g12 = 0;
				var _g3 = MouseControl.onMouseButtonDown.length;
				while(_g12 < _g3) {
					var i2 = _g12++;
					MouseControl.onMouseButtonDown[i2](2);
				}
			}
		}
	}
	,onMouseUp: function(button,x,y) {
		if(button == 0) {
			MouseControl.btnLeft = false;
			if(MouseControl.onMouseButtonUp != null) {
				var _g1 = 0;
				var _g = MouseControl.onMouseButtonUp.length;
				while(_g1 < _g) {
					var i = _g1++;
					MouseControl.onMouseButtonUp[i](0);
				}
			}
		}
		if(button == 1) {
			MouseControl.btnRight = false;
			if(MouseControl.onMouseButtonUp != null) {
				var _g11 = 0;
				var _g2 = MouseControl.onMouseButtonUp.length;
				while(_g11 < _g2) {
					var i1 = _g11++;
					MouseControl.onMouseButtonUp[i1](1);
				}
			}
		}
		if(button == 2) {
			MouseControl.btnMiddle = false;
			if(MouseControl.onMouseButtonUp != null) {
				var _g12 = 0;
				var _g3 = MouseControl.onMouseButtonUp.length;
				while(_g12 < _g3) {
					var i2 = _g12++;
					MouseControl.onMouseButtonUp[i2](2);
				}
			}
		}
	}
	,onMouseMove: function(_x,_y,_cx,_cy) {
		if(_x > 0) {
			MouseControl.x = _x;
		}
		if(_y > 0) {
	...
	,_onMouseWheel: function(_z) {
		MouseControl.z += _z;
		if(MouseControl.onMouseWheel != null) {
			MouseControl.onMouseWheel();
		}
	}
	,__class__: MouseControl
};
var Random = function() {
	this.mCounter = 0;
};
...
Random.SetMaxValue = function(maxValue) {
	Random.MaxValue = maxValue;
};
Random.SetMinValue = function(minValue) {
	Random.MinValue = minValue;
};
Random.Rnd = function() {
	Random.Counter++;
	var rnd = (Random.Seed * Random.Counter * 123456789 + 987654321) % 1593574862;
	haxe_Log.trace(rnd,{ fileName : "Random.hx", lineNumber : 22, className : "Random", methodName : "Rnd"});
	return rnd;
};
Random.Rnd2 = function(maxValue,minValue,seed) {
	Random.SetMaxValue(maxValue);
	Random.SetMinValue(minValue);
	Random.SetSeed(seed);
	Random.Counter++;
	var rnd = Math.pow(12345 + Random.Counter,2) % Random.Seed;
	rnd = Math.abs(Math.sin(rnd));
	rnd = Random.MinValue + rnd * (Random.MaxValue - Random.MinValue);
	return rnd;
};
Random.RndIter = function(maxValue,minValue,seed,Iteration) {
	var rnd = Math.pow(12345 + Iteration,2) % seed;
	rnd = Math.sin(rnd);
	rnd = minValue + rnd * (maxValue - minValue);
	return rnd;
};
Random.RndIter2 = function(maxValue,minValue,seed,Iteration) {
	var rnd = 0.0;
	if(seed > Iteration) {
...
Random.RndIter3 = function(maxValue,minValue,seed,Iteration) {
	var rnd = 0.0;
	var rnd1 = Math.pow(12345 + Iteration,2) % seed;
	rnd1 = (rnd1 - Math.round(rnd1 / 12345) * 12345) / 12345;
	rnd1 = minValue + rnd1 * (maxValue - minValue);
	return rnd1;
};
Random.RndGaus = function(maxValue,minValue,seed) {
	var const1 = 1.772453851;
	var q = 0.2;
	var m = 0;
	Random.Counter++;
	haxe_Log.trace("1: " + 1.0 / (q * const1) + "   : " + Math.pow(Random.Counter - m,2) + "   : " + 2 * Math.pow(q,2),{ fileName : "Random.hx", lineNumber : 81, className : "Random", methodName : "RndGaus"});
	haxe_Log.trace(Math.exp(-(Math.pow(Random.Counter - m,2) / (2 * Math.pow(q,2)))),{ fileName : "Random.hx", lineNumber : 82, className : "Random", methodName : "RndGaus"});
	var rnd = 1.0 / (q * const1) * Math.exp(-(Math.pow(Random.Counter - m,2) / (2 * Math.pow(q,2))));
	haxe_Log.trace(rnd,{ fileName : "Random.hx", lineNumber : 84, className : "Random", methodName : "RndGaus"});
	rnd = Random.MinValue + rnd * (Random.MaxValue - Random.MinValue);
	return rnd;
};
Random.CalcStarPosition = function(SpeenPower,SpeenRotate,StarsInSleeve,SeedSleeve) {
	var xStarPosition = 0.0;
	var yStarPosition = 0.0;
	var t = StarsInSleeve * 0.00016;
	var rnd = Random.RndIter3(0.9 / XmlControl.galaxySettings.galaxySleeve,-0.9 / XmlControl.galaxySettings.galaxySleeve,SeedSleeve,StarsInSleeve);
	...
	return new kha_math_Vector3(xStarPosition,yStarPosition,0);
};
Random.prototype = {
	mCounter: null
	,__class__: Random
...
var Set3d = function() {
	...
	this.CreatePipeline(Set3d.structure);
};
$hxClasses["Set3d"] = Set3d;
Set3d.__name__ = ["Set3d"];
Set3d.prototype = {
	CreateStructure: function() {
		Set3d.structure = new kha_graphics4_VertexStructure();
		Set3d.structure.add("pos",kha_graphics4_VertexData.Float3);
		Set3d.structure.add("uv",kha_graphics4_VertexData.Float2);
		Set3d.structure.add("color",kha_graphics4_VertexData.Float4);
		Set3d.structureLength = 9;
	}
	,CreatePipeline: function(s) {
		Set3d.pipeline = new kha_graphics4_PipelineState();
		Set3d.pipeline.inputLayout = [s];
		Set3d.pipeline.vertexShader = kha_Shaders.simple_vert;
		Set3d.pipeline.fragmentShader = kha_Shaders.simple_frag;
		Set3d.pipeline.depthWrite = false;
		Set3d.pipeline.depthMode = kha_graphics4_CompareMode.Less;
		Set3d.pipeline.blendDestination = kha_graphics4_BlendingFactor.DestinationAlpha;
		Set3d.pipeline.compile();
		Set3d.mvpID = Set3d.pipeline.getConstantLocation("MVP");
	}
	,__class__: Set3d
};
var Sleeve = function(starCount,speenPower,speenRotate) {
	this.speedStarShow = 10;
	this.cnt = 0;
	this.SpeenRotate = 0;
	this.SpeenPower = 0;
	this.stars = [];
...
Sleeve.prototype = {
	...
	,AddStar: function() {
		...
		if(Math.abs(SP.y) > Sleeve.MaxCoord) {
			Sleeve.MaxCoord = Math.abs(SP.y);
		}
		if(Math.abs(SP.x) > Sleeve.MaxCoord) {
			Sleeve.MaxCoord = Math.abs(SP.x);
		}
		var Chance = Math.abs(Math.sin(SP.x)) * StarPrototipe.ChanceCounter;
		var _g1 = 0;
		var _g = XmlControl.starPrototypes.length;
		while(_g1 < _g) {
			var i = _g1++;
			if(Chance > XmlControl.starPrototypes[i].stChanceMin && Chance < XmlControl.starPrototypes[i].stChanceMax) {
				this.stars.push(new Star(new kha_math_Vector3(SP.x,SP.y,0),XmlControl.starPrototypes[i].stColor,XmlControl.starPrototypes[i].stSize,XmlControl.starPrototypes[i].stLight,this.drawning,this.drawning2));
			}
		}
	}
	,cnt: null
	...
	,update: function() {
		...
		while(_g < _g1.length) {
			...
			++_g;
			this.cnt++;
			if(this.cnt > this.speedStarShow) {
				this.cnt = 0;
			}
			if((star.Id + this.cnt) % this.speedStarShow == 0) {
				star.update();
			}
		}
...
var Star = function(_pos,color,size,light,drb,drb2) {
	this.old_scaleFlare = 0;
	this.Size = size * Random.Rnd2(2.0,0.5,Galaxy.Seed) * 0.1;
	this.Light = light * Random.Rnd2(2.0,0.5,Galaxy.Seed);
	var star_uvs = [0,0,0,1,0.5,1,0,0,0.5,0,0.5,1];
	var flare_uvs = [0.5,0,0.5,1,1,1,0.5,0,1,0,1,1];
	this.Sprt = new Entity(new kha_math_Vector3(_pos.x,_pos.y,0),color,this.Size,drb,star_uvs);
	this.SprtFlare = new Entity(new kha_math_Vector3(_pos.x,_pos.y,0),color,1.1,drb2,flare_uvs,false);
	this.Id = Star.TotalCount;
	Star.TotalCount++;
};
$hxClasses["Star"] = Star;
Star.__name__ = ["Star"];
Star.prototype = {
	...
	,old_scaleFlare: null
	,update: function() {
		this.SprtFlare.Size = this.Light / 5000 * Base.camera.zoom;
		if(this.SprtFlare.Size != this.old_scaleFlare) {
			this.old_scaleFlare = this.SprtFlare.Size;
			this.SprtFlare.UpdateVert();
		}
	}
	,__class__: Star
};
...
var TextButton = function(x,y,width,height,Text,color,fontColor) {
	if(fontColor == null) {
		fontColor = -1;
	}
	if(color == null) {
	...
	Button.call(this,x,y,width,height,color);
	this.Text_btn = Text;
	this.font = kha_Assets.fonts.kenpixel_mini_square;
};
...
TextButton.prototype = $extend(Button.prototype,{
	...
	,FontColor: null
	,render: function(g) {
		Button.prototype.render.call(this,g);
		g.set_font(this.font);
		this.fontSize = 15;
		g.set_fontSize(this.fontSize);
		g.set_color(-1);
		g.drawString(this.Text_btn,this.x + this.width / 2 - this.font.width(this.fontSize,this.Text_btn) / 2,this.y + this.height / 2 - this.font.height(this.fontSize) / 2);
	}
...
var UiController = function() {
	this.font = kha_Assets.fonts.kenpixel_mini_square;
	this.fps = new FpsControl();
	this.AddStars10000_btn = new TextButton(10,Main.screen.y - 50 | 0,100,32,"+10k stars");
	this.AddStars10000_btn.onClick = function() {
		Base.galaxy.AddStars(10000);
	};
	this.AddStars1000_btn = new TextButton(120,Main.screen.y - 50 | 0,100,32,"+1k stars",-16776961);
	this.AddStars1000_btn.onClick = function() {
		Base.galaxy.AddStars(1000);
	};
};
$hxClasses["UiController"] = UiController;
UiController.__name__ = ["UiController"];
UiController.prototype = {
	font: null
	,AddStars1000_btn: null
	,AddStars10000_btn: null
	,fps: null
	,update: function() {
	}
	,render: function(g) {
		...
		this.AddStars1000_btn.render(g);
		this.AddStars10000_btn.render(g);
		g.set_font(this.font);
		g.set_fontSize(15);
		g.set_color(-1);
		...
		g.drawString("FPS: " + this.fps.FPS + " ;",10,90);
	}
	,__class__: UiController
};
...
var StarPrototipe = function(_stType,_stLight,_stSize,_stColor,_stChance) {
	this.stType = _stType;
	this.stLight = _stLight;
	this.stSize = _stSize;
	this.stColor = _stColor;
	this.stChanceMin = StarPrototipe.ChanceCounter;
	StarPrototipe.ChanceCounter += _stChance;
	this.stChanceMax = StarPrototipe.ChanceCounter;
	haxe_Log.trace("Chanses: " + this.stChanceMin + " - " + this.stChanceMax + " type of " + this.stType + "   _stLight " + _stLight,{ fileName : "XmlControl.hx", lineNumber : 33, className : "StarPrototipe", methodName : "new"});
};
$hxClasses["StarPrototipe"] = StarPrototipe;
StarPrototipe.__name__ = ["StarPrototipe"];
StarPrototipe.prototype = {
	stType: null
	,stLight: null
	,stSize: null
	,stColor: null
	,stChanceMax: null
	,stChanceMin: null
	,__class__: StarPrototipe
};
var GalaxySettings = function(_starCount,_galaxySleeve,_speenPower,_Seed) {
	this.starCount = _starCount;
	this.galaxySleeve = _galaxySleeve;
	this.speenPower = _speenPower;
	this.Seed = _Seed;
};
$hxClasses["GalaxySettings"] = GalaxySettings;
GalaxySettings.__name__ = ["GalaxySettings"];
GalaxySettings.prototype = {
	starCount: null
	,galaxySleeve: null
	,speenPower: null
	,Seed: null
	,__class__: GalaxySettings
};
var XmlControl = function() {
	XmlControl.starPrototypes = [];
	StarPrototipe.ChanceCounter = 0;
	var cont = kha_Assets.blobs.settings_xml.toString();
	var f = new haxe_xml_Fast(Xml.parse(cont));
	var stars = f.node.resolve("settings").nodes.resolve("star");
	var glx = f.node.resolve("settings").node.resolve("galaxy");
	XmlControl.galaxySettings = new GalaxySettings(Std.parseInt(glx.att.resolve("StarCount")),Std.parseInt(glx.att.resolve("SleeveCount")),parseFloat(glx.att.resolve("SpeenPower")),Std.parseInt(glx.att.resolve("seed")));
	var _g_head = stars.h;
	while(_g_head != null) {
		var val = _g_head.item;
		_g_head = _g_head.next;
		var star = val;
		XmlControl.starPrototypes.push(new StarPrototipe(Std.parseInt(star.att.resolve("type")),parseFloat(star.att.resolve("light")),parseFloat(star.att.resolve("size")),kha__$Color_Color_$Impl_$.fromBytes(Std.parseInt(star.node.resolve("color").att.resolve("red")),Std.parseInt(star.node.resolve("color").att.resolve("green")),Std.parseInt(star.node.resolve("color").att.resolve("blue")),255),parseFloat(star.att.resolve("chance"))));
	}
};
$hxClasses["XmlControl"] = XmlControl;
XmlControl.__name__ = ["XmlControl"];
XmlControl.prototype = {
	__class__: XmlControl
};
...
var kha__$Assets_ImageList = function() {
	this.names = ["ImageData","ImgData","Light3","fon2","enemyShip","playerShip"];
	this.playerShipDescription = { files : ["playerShip.png"], original_height : 75, type : "image", original_width : 99, name : "playerShip"};
	this.playerShipName = "playerShip";
	this.playerShip = null;
	this.enemyShipDescription = { files : ["enemyShip.png"], original_height : 84, type : "image", original_width : 93, name : "enemyShip"};
	this.enemyShipName = "enemyShip";
	this.enemyShip = null;
	this.fon2Description = { files : ["fon2.png"], original_height : 1024, type : "image", original_width : 1024, name : "fon2"};
	this.fon2Name = "fon2";
	this.fon2 = null;
	this.Light3Description = { files : ["Light3.png"], original_height : 256, type : "image", original_width : 256, name : "Light3"};
	this.Light3Name = "Light3";
	this.Light3 = null;
	this.ImgDataDescription = { files : ["ImgData.png"], original_height : 256, type : "image", original_width : 512, name : "ImgData"};
	this.ImgDataName = "ImgData";
	this.ImgData = null;
	this.ImageDataDescription = { files : ["ImageData.png"], original_height : 256, type : "image", original_width : 512, name : "ImageData"};
	this.ImageDataName = "ImageData";
	this.ImageData = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,ImageData: null
	,ImageDataName: null
	,ImageDataDescription: null
	,ImageDataLoad: function(done) {
		kha_Assets.loadImage("ImageData",function(image) {
			done();
		});
	}
	,ImageDataUnload: function() {
		this.ImageData.unload();
		this.ImageData = null;
	}
	,ImgData: null
	,ImgDataName: null
	,ImgDataDescription: null
	,ImgDataLoad: function(done) {
		kha_Assets.loadImage("ImgData",function(image) {
			done();
		});
	}
	,ImgDataUnload: function() {
		this.ImgData.unload();
		this.ImgData = null;
	}
	,Light3: null
	,Light3Name: null
	,Light3Description: null
	,Light3Load: function(done) {
		kha_Assets.loadImage("Light3",function(image) {
			done();
		});
	}
	,Light3Unload: function() {
		this.Light3.unload();
		this.Light3 = null;
	}
	,fon2: null
	,fon2Name: null
	,fon2Description: null
	,fon2Load: function(done) {
		kha_Assets.loadImage("fon2",function(image) {
			done();
		});
	}
	,fon2Unload: function() {
	...
	,enemyShip: null
	,enemyShipName: null
	,enemyShipDescription: null
	,enemyShipLoad: function(done) {
		kha_Assets.loadImage("enemyShip",function(image) {
			done();
		});
	}
	,enemyShipUnload: function() {
		this.enemyShip.unload();
		this.enemyShip = null;
	}
	,playerShip: null
	,playerShipName: null
	,playerShipDescription: null
	,playerShipLoad: function(done) {
		kha_Assets.loadImage("playerShip",function(image) {
			done();
		});
	}
	,playerShipUnload: function() {
		this.playerShip.unload();
		this.playerShip = null;
	}
	,names: null
...
var kha__$Assets_BlobList = function() {
	this.names = ["set_json","Без_имени_1_psb","settings_xml"];
	this.settings_xmlDescription = { files : ["settings.xml"], type : "blob", name : "settings_xml"};
	this.settings_xmlName = "settings_xml";
	this.settings_xml = null;
	this["Без_имени_1_psbDescription"] = { files : ["Без имени-1.psb"], type : "blob", name : "Без_имени_1_psb"};
	this["Без_имени_1_psbName"] = "Без_имени_1_psb";
	this["Без_имени_1_psb"] = null;
	this.set_jsonDescription = { files : ["set.json"], type : "blob", name : "set_json"};
	this.set_jsonName = "set_json";
	this.set_json = null;
};
...
kha__$Assets_BlobList.prototype = {
	...
	,set_json: null
	,set_jsonName: null
	,set_jsonDescription: null
	,set_jsonLoad: function(done) {
		kha_Assets.loadBlob("set_json",function(blob) {
			done();
		});
	}
	,set_jsonUnload: function() {
		this.set_json.unload();
		this.set_json = null;
	}
	,'Без_имени_1_psb': null
	,'Без_имени_1_psbName': null
	,'Без_имени_1_psbDescription': null
	,'Без_имени_1_psbLoad': function(done) {
		kha_Assets.loadBlob("Без_имени_1_psb",function(blob) {
			done();
		});
	}
	,'Без_имени_1_psbUnload': function() {
		this["Без_имени_1_psb"].unload();
		this["Без_имени_1_psb"] = null;
	}
	,settings_xml: null
	,settings_xmlName: null
	,settings_xmlDescription: null
	,settings_xmlLoad: function(done) {
		kha_Assets.loadBlob("settings_xml",function(blob) {
			done();
		});
	}
	,settings_xmlUnload: function() {
		this.settings_xml.unload();
		this.settings_xml = null;
	}
	,names: null
...
var kha__$Assets_FontList = function() {
	this.names = ["kenpixel_mini_square"];
	this.kenpixel_mini_squareDescription = { files : ["kenpixel_mini_square.ttf"], type : "font", name : "kenpixel_mini_square"};
	this.kenpixel_mini_squareName = "kenpixel_mini_square";
	this.kenpixel_mini_square = null;
};
...
kha__$Assets_FontList.prototype = {
	...
	,kenpixel_mini_square: null
	,kenpixel_mini_squareName: null
	,kenpixel_mini_squareDescription: null
	,kenpixel_mini_squareLoad: function(done) {
		kha_Assets.loadFont("kenpixel_mini_square",function(font) {
			done();
		});
	}
	,kenpixel_mini_squareUnload: function() {
		this.kenpixel_mini_square.unload();
		this.kenpixel_mini_square = null;
	}
	,names: null
...
kha_Shaders.init = function() {
	...
	while(_g8 < 3) {
		var i8 = _g8++;
		var data8 = Reflect.field(kha_Shaders,"simple_fragData" + i8);
		var bytes8 = haxe_Unserializer.run(data8);
		blobs8.push(kha_internal_BytesBlob.fromBytes(bytes8));
	}
	kha_Shaders.simple_frag = new kha_graphics4_FragmentShader(blobs8,["simple.frag.essl","simple-relaxed.frag.essl","simple-webgl2.frag.essl"]);
	var blobs9 = [];
	var _g9 = 0;
	while(_g9 < 3) {
		var i9 = _g9++;
		var data9 = Reflect.field(kha_Shaders,"simple_vertData" + i9);
		var bytes9 = haxe_Unserializer.run(data9);
		blobs9.push(kha_internal_BytesBlob.fromBytes(bytes9));
	}
	kha_Shaders.simple_vert = new kha_graphics4_VertexShader(blobs9,["simple.vert.essl","simple-relaxed.vert.essl","simple-webgl2.vert.essl"]);
};
...
var kha_graphics1_Graphics4 = function(canvas) {
	this.canvas = canvas;
};
$hxClasses["kha.graphics1.Graphics4"] = kha_graphics1_Graphics4;
kha_graphics1_Graphics4.__name__ = ["kha","graphics1","Graphics4"];
kha_graphics1_Graphics4.__interfaces__ = [kha_graphics4_Graphics];
kha_graphics1_Graphics4.min = function(a,b,c) {
	var min1 = a < b ? a : b;
	if(min1 < c) {
		return min1;
	} else {
...
kha_graphics1_Graphics4.max = function(a,b,c) {
	var max1 = a > b ? a : b;
	if(max1 > c) {
		return max1;
	} else {
...
kha_graphics1_Graphics4.vec2 = function(x,y) {
	return [x,y];
};
kha_graphics1_Graphics4.vec3 = function(x,y,z) {
	return [x,y,z];
};
kha_graphics1_Graphics4.vec4 = function(x,y,z,w) {
	return [x,y,z,w];
};
kha_graphics1_Graphics4.mat4 = function(x,y) {
	return [x,y];
};
kha_graphics1_Graphics4.barycentric = function(_1x,_1y,_2x,_2y,_3x,_3y,x,y) {
	var a_z;
	var a_y;
	var a_x = _3x - _1x;
	a_y = _2x - _1x;
	...
	var u_y;
	var u_x;
	var _x = a_y * b_z - a_z * b_y;
	var _y = a_z * b_x - a_x * b_z;
	var _z = a_x * b_y - a_y * b_x;
	u_x = _x;
	u_y = _y;
	u_z = _z;
	if(Math.abs(u_z) < 1) {
		return new kha_math_FastVector3(-1,1,1);
	}
	return new kha_math_FastVector3(1.0 - (u_x + u_y) / u_z,u_y / u_z,u_x / u_z);
};
kha_graphics1_Graphics4.prototype = {
	canvas: null
	,g1: null
	,indexBuffer: null
	,vertexBuffer: null
	...
	,setFloats: function(location,floats) {
	}
	,setFloat4s: function(location,float4s) {
	}
	...
	,setMatrix: function(location,value) {
	}
	,setMatrix3: function(location,value) {
	}
	,xtopixel: function(x) {
		return (x + 1) / 2 * this.canvas.get_width() | 0;
	}
	,ytopixel: function(y) {
		return (y + 1) / 2 * this.canvas.get_height() | 0;
	}
	,drawIndexedVertices: function(start,count) {
		...
		var vertexShader = shader_vert;
		var fragmentShader = shader_frag;
		var index = 0;
		while(index < this.indexBuffer._data.length) {
			var indices_0 = this.indexBuffer._data[index];
			var indices_1 = this.indexBuffer._data[index + 1];
			var indices_2 = this.indexBuffer._data[index + 2];
			var layout = this.pipeline.inputLayout[0];
			var vertexStride = layout.byteSize() / 4 | 0;
			var offsets = [indices_0 * vertexStride,indices_1 * vertexStride,indices_2 * vertexStride];
			var vsinputs = [];
			var _g = 0;
			while(_g < 3) {
				var index1 = _g++;
				...
				var vindex = 0;
				var _g1 = 0;
				var _g2 = layout.elements;
				while(_g1 < _g2.length) {
					var element = _g2[_g1];
					++_g1;
					var _g3 = element.data;
					switch(_g3[1]) {
					case 0:
						var data1 = this.vertexBuffer._data[offsets[index1] + vindex];
						vsinput[element.name] = data1;
						++vindex;
						break;
					case 1:
						var data2 = [this.vertexBuffer._data[offsets[index1] + vindex],this.vertexBuffer._data[offsets[index1] + vindex + 1]];
						vsinput[element.name] = data2;
						vindex += 2;
						break;
					case 2:
						var data3 = [this.vertexBuffer._data[offsets[index1] + vindex],this.vertexBuffer._data[offsets[index1] + vindex + 1],this.vertexBuffer._data[offsets[index1] + vindex + 2]];
						vsinput[element.name] = data3;
						vindex += 3;
						break;
					case 3:
						var data4 = [this.vertexBuffer._data[offsets[index1] + vindex],this.vertexBuffer._data[offsets[index1] + vindex + 1],this.vertexBuffer._data[offsets[index1] + vindex + 2],this.vertexBuffer._data[offsets[index1] + vindex + 3]];
						vsinput[element.name] = data4;
						vindex += 4;
						break;
					case 4:
						break;
			...
			while(_g4 < 3) {
				var i = _g4++;
				vertexShader(vsinputs[i],vsoutputs[i],kha_graphics1_Graphics4.vec2,kha_graphics1_Graphics4.vec3,kha_graphics1_Graphics4.vec4,kha_graphics1_Graphics4.mat4);
			}
			var positions_0 = vsoutputs[0].gl_Position;
			var positions_1 = vsoutputs[1].gl_Position;
			var positions_2 = vsoutputs[2].gl_Position;
			var a = positions_0[0];
			var b = positions_1[0];
			var c = positions_2[0];
			var min1 = a < b ? a : b;
			var minx = min1 < c ? min1 : c;
			var a1 = positions_0[0];
			var b1 = positions_1[0];
			var c1 = positions_2[0];
			var max1 = a1 > b1 ? a1 : b1;
			var maxx = max1 > c1 ? max1 : c1;
			var a2 = positions_0[1];
			var b2 = positions_1[1];
			var c2 = positions_2[1];
			var min11 = a2 < b2 ? a2 : b2;
			var miny = min11 < c2 ? min11 : c2;
			var a3 = positions_0[1];
			var b3 = positions_1[1];
			var c3 = positions_2[1];
			var max11 = a3 > b3 ? a3 : b3;
			var maxy = max11 > c3 ? max11 : c3;
			var minxp = (minx + 1) / 2 * this.canvas.get_width() | 0;
			var maxxp = (maxx + 1) / 2 * this.canvas.get_width() | 0;
			var minyp = (miny + 1) / 2 * this.canvas.get_height() | 0;
			var maxyp = (maxy + 1) / 2 * this.canvas.get_height() | 0;
			var _g11 = minyp;
			var _g5 = maxyp;
			while(_g11 < _g5) {
				var y = _g11++;
				...
				while(_g31 < _g21) {
					var x = _g31++;
					var _1x = (positions_0[0] + 1) / 2 * this.canvas.get_width() | 0;
					var _1y = (positions_0[1] + 1) / 2 * this.canvas.get_height() | 0;
					var _2x = (positions_1[0] + 1) / 2 * this.canvas.get_width() | 0;
					var _2y = (positions_1[1] + 1) / 2 * this.canvas.get_height() | 0;
					var a_z;
					var a_y;
					var a_x = ((positions_2[0] + 1) / 2 * this.canvas.get_width() | 0) - _1x;
					a_y = _2x - _1x;
					a_z = _1x - x;
					var b_z;
					var b_y;
					var b_x = ((positions_2[1] + 1) / 2 * this.canvas.get_height() | 0) - _1y;
					b_y = _2y - _1y;
					b_z = _1y - y;
					var u_z;
					var u_y;
					...
					u_y = _y;
					u_z = _z;
					var bc_screen = Math.abs(u_z) < 1 ? new kha_math_FastVector3(-1,1,1) : new kha_math_FastVector3(1.0 - (u_x + u_y) / u_z,u_y / u_z,u_x / u_z);
					if(bc_screen.x < 0 || bc_screen.y < 0 || bc_screen.z < 0) {
						continue;
					}
					var fsoutput = { };
					fragmentShader({ },fsoutput,kha_graphics1_Graphics4.vec2,kha_graphics1_Graphics4.vec3,kha_graphics1_Graphics4.vec4,kha_graphics1_Graphics4.mat4);
					var color = fsoutput.gl_FragColor;
					this.g1.setPixel(x,y,kha__$Color_Color_$Impl_$.fromFloats(color[2],color[1],color[0],color[3]));
				}
			}
			index += 3;
		}
	...
	,__class__: kha_graphics1_Graphics4
};
...
kha_CompilerDefines.kha_output = "C:\\Users\\SergSS\\Documents\\HAXE\\test\\build\\html5\\kha.js";
...
kha_Shaders.painter_colored_fragData1 = "s207:I3ZlcnNpb24gMTAwDQpwcmVjaXNpb24gbWVkaXVtcCBmbG9hdDsNCnByZWNpc2lvbiBtZWRpdW1wIGludDsNCg0KdmFyeWluZyB2ZWM0IGZyYWdtZW50Q29sb3I7DQoNCnZvaWQgbWFpbigpDQp7DQogICAgZ2xfRnJhZ0RhdGFbMF0gPSBmcmFnbWVudENvbG9yOw0KfQ0KDQo";
kha_Shaders.painter_colored_fragData2 = "s226:I3ZlcnNpb24gMzAwIGVzDQpwcmVjaXNpb24gbWVkaXVtcCBmbG9hdDsNCnByZWNpc2lvbiBtZWRpdW1wIGludDsNCg0Kb3V0IHZlYzQgRnJhZ0NvbG9yOw0KaW4gdmVjNCBmcmFnbWVudENvbG9yOw0KDQp2b2lkIG1haW4oKQ0Kew0KICAgIEZyYWdDb2xvciA9IGZyYWdtZW50Q29sb3I7DQp9DQoNCg";
...
kha_Shaders.painter_image_fragData1 = "s467:";
kha_Shaders.painter_image_fragData2 = "s476:";
...
kha_Shaders.painter_colored_vertData1 = "s392:";
kha_Shaders.painter_colored_vertData2 = "s372:";
...
kha_Shaders.painter_image_vertData1 = "s502:";
kha_Shaders.painter_image_vertData2 = "s467:";
...
kha_Shaders.painter_text_fragData1 = "s359:";
kha_Shaders.painter_text_fragData2 = "s368:";
...
kha_Shaders.painter_video_fragData1 = "s467:";
kha_Shaders.painter_video_fragData2 = "s476:";
...
kha_Shaders.painter_text_vertData1 = "s523:";
kha_Shaders.painter_text_vertData2 = "s488:";
...
kha_Shaders.painter_video_vertData1 = "s502:";
kha_Shaders.painter_video_vertData2 = "s467:";
kha_Shaders.simple_fragData0 = "s415:";
kha_Shaders.simple_fragData1 = "s396:";
kha_Shaders.simple_fragData2 = "s406:";
kha_Shaders.simple_vertData0 = "s336:";
kha_Shaders.simple_vertData1 = "s400:";
kha_Shaders.simple_vertData2 = "s366:";
